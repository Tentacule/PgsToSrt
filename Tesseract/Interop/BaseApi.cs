...
namespace Tesseract.Interop
{
    ...
    {
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetComponentImages")]
        IntPtr BaseAPIGetComponentImages(HandleRef handle, PageIteratorLevel level, int text_only, IntPtr pixa, IntPtr blockids);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIAnalyseLayout")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIDetectOrientationScript")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetDoubleVariable")]
        int BaseApiGetDoubleVariable(HandleRef handle, string name, out double value);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetHOCRText")]
        IntPtr BaseAPIGetHOCRTextInternal(HandleRef handle, int pageNum);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetIntVariable")]
        int BaseApiGetIntVariable(HandleRef handle, string name, out int value);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetIterator")]
        IntPtr BaseApiGetIterator(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetPageSegMode")]
        PageSegMode BaseAPIGetPageSegMode(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetStringVariable")]
        ...
        //[RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIProcessPages")]
        //int BaseAPIProcessPages(HandleRef handle, string filename, string retry_config, int timeout_millisec, HandleRef renderer);

        //[RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIProcessPage")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIGetDatapath")]
        string BaseAPIGetDatapath(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPISetOutputName")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIMeanTextConf")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPISetDebugVariable")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPISetVariable")]
        int BaseApiSetVariable(HandleRef handle, string name, IntPtr valPtr);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessDeleteBlockList")]
        void DeleteBlockList(IntPtr arr);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessDeleteIntArray")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessDeleteTextArray")]
        void DeleteTextArray(IntPtr arr);

        // Helper functions
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessVersion")]
        string GetVersion();

        // result iterator

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBaseline")]
        int PageIteratorBaseline(HandleRef handle, PageIteratorLevel level, out int x1, out int y1, out int x2, out int y2);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBegin")]
        void PageIteratorBegin(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBlockType")]
        PolyBlockType PageIteratorBlockType(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorBoundingBox")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorCopy")]
        IntPtr PageIteratorCopy(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorDelete")]
        void PageIteratorDelete(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorGetBinaryImage")]
        IntPtr PageIteratorGetBinaryImage(HandleRef handle, PageIteratorLevel level);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorGetImage")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorIsAtBeginningOf")]
        int PageIteratorIsAtBeginningOf(HandleRef handle, PageIteratorLevel level);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorIsAtFinalElement")]
        int PageIteratorIsAtFinalElement(HandleRef handle, PageIteratorLevel level, PageIteratorLevel element);

        // page iterator
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorNext")]
        int PageIteratorNext(HandleRef handle, PageIteratorLevel level);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPageIteratorOrientation")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorCopy")]
        IntPtr ResultIteratorCopy(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorDelete")]
        void ResultIteratorDelete(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorConfidence")]
        float ResultIteratorGetConfidence(HandleRef handle, PageIteratorLevel level);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorWordFontAttributes")]
        ...
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorWordIsFromDictionary")]
        bool ResultIteratorWordIsFromDictionary(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorWordIsNumeric")]
        bool ResultIteratorWordIsNumeric(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorWordRecognitionLanguage")]
        IntPtr ResultIteratorWordRecognitionLanguageInternal(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorSymbolIsSuperscript")]
        bool ResultIteratorSymbolIsSuperscript(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorSymbolIsSubscript")]
        bool ResultIteratorSymbolIsSubscript(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorSymbolIsDropcap")]
        bool ResultIteratorSymbolIsDropcap(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorGetPageIterator")]
        IntPtr ResultIteratorGetPageIterator(HandleRef handle);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorGetUTF8Text")]
        ...
        /// <returns></returns>
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultIteratorGetChoiceIterator")]
        ...
        /// </summary>
        /// <param name="handle"></param>
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessChoiceIteratorDelete")]
        ...
        /// <param name="handle"></param>
        /// <returns></returns>
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessChoiceIteratorNext")]
        ...
        /// <param name="handle"></param>
        /// <returns></returns>
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessChoiceIteratorGetUTF8Text")]
        ...
        /// <param name="handle"></param>
        /// <returns></returns>
        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessChoiceIteratorConfidence")]
        float ChoiceIteratorGetConfidence(HandleRef handle);

        #endregion Choice Iterator

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIPrintVariablesToFile")]
        int BaseApiPrintVariablesToFile(HandleRef handle, string filename);

        #region Renderer API

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessTextRendererCreate")]
        IntPtr TextRendererCreate(string outputbase);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessHOcrRendererCreate")]
        IntPtr HOcrRendererCreate(string outputbase);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessHOcrRendererCreate2")]
        IntPtr HOcrRendererCreate2(string outputbase, int font_info);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPDFRendererCreate")]
        IntPtr PDFRendererCreate(string outputbase, IntPtr datadir);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessPDFRendererCreateTextonly")]
        IntPtr PDFRendererCreateTextonly(string outputbase, IntPtr datadir, int textonly);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessUnlvRendererCreate")]
        IntPtr UnlvRendererCreate(string outputbase);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBoxTextRendererCreate")]
        IntPtr BoxTextRendererCreate(string outputbase);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessDeleteResultRenderer")]
        void DeleteResultRenderer(HandleRef renderer);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererInsert")]
        void ResultRendererInsert(HandleRef renderer, HandleRef next);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererNext")]
        IntPtr ResultRendererNext(HandleRef renderer);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererBeginDocument")]
        int ResultRendererBeginDocument(HandleRef renderer, IntPtr titlePtr);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererAddImage")]
        int ResultRendererAddImage(HandleRef renderer, HandleRef api);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererEndDocument")]
        int ResultRendererEndDocument(HandleRef renderer);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererExtention")]
        IntPtr ResultRendererExtention(HandleRef renderer);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererTitle")]
        IntPtr ResultRendererTitle(HandleRef renderer);

        [RuntimeDllImport(Constants.TesseractDllNameWindows, Constants.TesseractDllNameUnix, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessResultRendererImageNum")]
