...
namespace Tesseract.Interop
{
    ...
    public interface ILeptonicaApiSignatures
    {
        ...
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaReadMultipageTiff")]
        IntPtr pixaReadMultipageTiff(string filename);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaCreate")]
        IntPtr pixaCreate(int n);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaAddPix")]
        int pixaAddPix(HandleRef pixa, HandleRef pix, PixArrayAccessType copyflag);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaGetPix")]
        IntPtr pixaGetPix(HandleRef pixa, int index, PixArrayAccessType accesstype);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaRemovePix")]
        int pixaRemovePix(HandleRef pixa, int index);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaClear")]
        int pixaClear(HandleRef pixa);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaGetCount")]
        int pixaGetCount(HandleRef pixa);
       
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaDestroy")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixGetResolution")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSetResolution")]
        int pixSetResolution(HandleRef pix, int xres, int yres);


        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixScaleResolution")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixGetInputFormat")]
        ImageFormat pixGetInputFormat(HandleRef pix);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSetInputFormat")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixRead")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixReadMemTiff")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixDisplayWrite")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixConvertRGBToGray")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixDeskewGeneral")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixFindSkew")]
        int pixFindSkew(HandleRef pixs, out float pangle, out float pconf);

        // rotation

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixRotate")]
        IntPtr pixRotate(HandleRef pixs, float angle, RotationMethod type, RotationFill fillColor, int width, int heigh);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixRotateOrth")]
        IntPtr pixRotateOrth(HandleRef pixs, int quads);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixRotateAMGray")]
        IntPtr pixRotateAMGray(HandleRef pixs, float angle, byte grayval);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixRotate90")]
        IntPtr pixRotate90(HandleRef pixs, int direction);

        // Grayscale

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixCloseGray")]
        IntPtr pixCloseGray(HandleRef pixs, int hsize, int vsize);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixErodeGray")]
        IntPtr pixErodeGray(HandleRef pixs, int hsize, int vsize);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixAddGray")]
        IntPtr pixAddGray(HandleRef pixd, HandleRef pixs1, HandleRef pixs2);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixOpenGray")]
        IntPtr pixOpenGray(HandleRef pixs, int hsize, int vsize);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixCombineMasked")]
        int pixCombineMasked(HandleRef pixd, HandleRef pixs, HandleRef pixm);

        // Threshold

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixThresholdToValue")]
        IntPtr pixThresholdToValue(HandleRef pixd, HandleRef pixs, int threshval, int setval);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixThresholdToBinary")]
        IntPtr pixThresholdToBinary(HandleRef pixs, int thresh);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixInvert")]
        IntPtr pixInvert(HandleRef pixd, HandleRef pixs);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixBackgroundNormFlex")]
        IntPtr pixBackgroundNormFlex(HandleRef pixs, int sx, int sy, int smoothx, int smoothy, int delta);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)][RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixGammaTRCMasked")]
        IntPtr pixGammaTRCMasked(HandleRef pixd, HandleRef pixs, HandleRef pixm, float gamma, int minval, int maxval);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)][RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixHMT")]
        IntPtr pixHMT(HandleRef pixd, HandleRef pixs, HandleRef sel);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixDilate")]
        IntPtr pixDilate(HandleRef pixd, HandleRef pixs, HandleRef sel);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSubtract")]
        IntPtr pixSubtract(HandleRef pixd, HandleRef pixs1, HandleRef pixs2);

        // Sel

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "selCreateFromString")]
        IntPtr selCreateFromString(string text, int h, int w, string name);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "selCreateBrick")]
        IntPtr selCreateBrick(int h, int w, int cy, int cx, SelType type);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "selDestroy")]
        void selDestroy(ref IntPtr psel);

        // Binarization - src/binarize.c

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixOtsuAdaptiveThreshold")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSauvolaBinarize")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSauvolaBinarizeTiled")]
        int pixSauvolaBinarizeTiled(HandleRef pix, int whsize, float factor, int nx, int ny, out IntPtr ppixth, out IntPtr ppixd);

        // Scaling - src/scale.c

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixScale")]
        ...
        /// <returns>The pointer to the colormap, or null on error.</returns>
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapCopy")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetMinDepth")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetColor")]
        ...
        /// </summary>
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetIndex")]
        ...
        /// <returns>Returns 0 if OK; 1 on error.</returns>
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapHasColor")]
        ...
        /// <returns>Returns 0 if OK; 1 on error.</returns>
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapCountGrayColors")]
        ...
        /// <returns>Returns 0 if OK; 1 on error.</returns>
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetNearestIndex")]
        ...
        /// <returns>Returns 0 if OK; 1 on error.</returns>
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetNearestGrayIndex")]
        int pixcmapGetNearestGrayIndex(HandleRef cmap, int val, out int index);

        // color map conversion

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGrayToColor")]
        IntPtr pixcmapGrayToColor(int color);


        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapColorToGray")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapToRGBTable")]
        int pixcmapToRGBTable(HandleRef cmap, out IntPtr colorTable, out int colorCount);


        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapSerializeToMemory")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapDeserializeFromMemory")]
        IntPtr pixcmapDeserializeFromMemory(HandleRef colorData, int colorCount, int colorDataLength);

        // colormap transformations 

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGammaTRC")]
        int pixcmapGammaTRC(HandleRef cmap, float gamma, int minVal, int maxVal);


        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapContrastTRC")]
        int pixcmapContrastTRC(HandleRef cmap, float factor);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapShiftIntensity")]
        ...
        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "boxaGetCount")]
        int boxaGetCount(HandleRef boxa);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "boxaGetBox")]
        IntPtr boxaGetBox(HandleRef boxa, int index, PixArrayAccessType accesstype);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "boxGetGeometry")]
        int boxGetGeometry(HandleRef box, out int px, out int py, out int pw, out int ph);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "boxDestroy")]
        void boxDestroy(ref IntPtr box);

        [NativeLoaderOverride(LibraryName = Constants.LeptonicaWindowsDllName, Platform = Platform.Windows)]
        [RuntimeUnmanagedFunctionPointer(LibraryName = Constants.LeptonicaLibraryName, LibraryVersion = "5", CallingConvention = CallingConvention.Cdecl, EntryPoint = "boxaDestroy")]
    ...
    unsafe static class LeptonicaApi
    {
        ...
        public static void Initialize()
        {
            if (native == null)
            {
                native = Constants.Loader.CreateInstance<ILeptonicaApiSignatures>();
            }
        }
    }
}
